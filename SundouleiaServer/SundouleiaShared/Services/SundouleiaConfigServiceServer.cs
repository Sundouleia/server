...
/// <summary>
///     The configuration services for the server end of the Sundouleia application
/// </summary>
public class SundouleiaConfigServiceServer<T> : IConfigurationService<T> where T : class, ISundouleiaConfiguration
{
    private readonly IOptionsMonitor<T> _config;
    public bool IsMain => true;

    public SundouleiaConfigServiceServer(IOptionsMonitor<T> config)
    {
        _config = config;
    }
