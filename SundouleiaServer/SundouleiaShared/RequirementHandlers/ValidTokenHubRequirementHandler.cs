...
/// <summary>
///     The handler class for valid token requirement
/// </summary>
public class ValidTokenRequirementHandler : AuthorizationHandler<ValidTokenRequirement>
{
    // Generic override the handler requirements via the valid token requirement.
    protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, ValidTokenRequirement requirement)
    {
        ...
        var expirationClaimValue = context.User.Claims.SingleOrDefault(r => string.Equals(r.Type, SundouleiaClaimTypes.Expires, StringComparison.Ordinal));
...
/// <summary>
///     The handler class for valid token requirement for the hub.
/// </summary>
public class ValidTokenHubRequirementHandler : AuthorizationHandler<ValidTokenRequirement, HubInvocationContext>
{
    // Override the handler requirements for hub invocation context via the valid token requirement.
