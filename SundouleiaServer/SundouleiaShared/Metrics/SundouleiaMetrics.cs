...
/// <summary> 
///     The metrics class for Sundouleia.
///     Track a number of server operations performed for use of analytics.
///     This is primarily to help find where to best improve performance.
/// </summary>
public class SundouleiaMetrics
{
    public SundouleiaMetrics(ILogger<SundouleiaMetrics> logger, List<string> countersToServe, List<string> gaugesToServe)
    {
        logger.LogInformation("Initializing SundouleiaMetrics");
    ...
    /// <summary>
    ///     Increments a gauge by an amount, or 1 by default.
    /// </summary>
    ...
    /// <summary>
    ///     Decrements a gauge by an amount, or 1 by default.
    /// </summary>
