...
public class ServerTokenGenerator
{
    ...
    public ServerTokenGenerator(IOptionsMonitor<SundouleiaConfigBase> configuration, ILogger<ServerTokenGenerator> logger)
    {
    ...
    private string GenerateToken()
    {
        ...
        var token = new SecurityTokenDescriptor()
        {
            ...
            {
                new Claim(SundouleiaClaimTypes.Uid, "CkSundouleiaServer"),
                new Claim(SundouleiaClaimTypes.Internal, "true"),
                new Claim(SundouleiaClaimTypes.Expires, DateTime.Now.AddYears(1).Ticks.ToString(CultureInfo.InvariantCulture))
            }),
