...
public class SundouleiaConfigBase : ISundouleiaConfiguration
{
    ...
    public Uri MainServerAddress { get; set; }          // The address of the main server (for other shards to connect to when we need to make them)
