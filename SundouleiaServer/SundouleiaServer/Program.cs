...
/// <summary> The primary program class for the SundouleiaServer. Calls Main() </summary>
    ...
    public static void Main(string[] args)
    {
        ...
        using (IServiceScope scope = host.Services.CreateScope())
        {
            ...
            if (options.IsMain)
            {
                ...
                IQueryable<SundouleiaShared.Models.AccountClaimAuth> unfinishedRegistrations = context.AccountClaimAuth.Where(c => c.StartedAt != null);
            ...
            SundouleiaMetrics metrics = services.GetRequiredService<SundouleiaMetrics>();

            metrics.SetGaugeTo(MetricsAPI.GaugeUsersRegistered, context.Users.AsNoTracking().Count());
            metrics.SetGaugeTo(MetricsAPI.GaugePairings, context.ClientPairs.AsNoTracking().Count());
            metrics.SetGaugeTo(MetricsAPI.GaugeRequestsPending, context.Requests.AsNoTracking().Count());
        }
