...
namespace SundouleiaServer.Listeners;
public class DbNotificationListener : IHostedService
{
    ...
    public DbNotificationListener(ILogger<DbNotificationListener> logger, 
        IDbContextFactory<SundouleiaDbContext> SundouleiaDbContextFactory,
        IHubContext<SundouleiaHub, ISundouleiaHub> hubContext, IConfiguration configuration)
    {
        _dbContextFactory = SundouleiaDbContextFactory;
    ...
    private async Task ListenForNotificationsAsync()
    {
        ...
        connection.Notification += async (o, e) =>
        {
            ...
            try
            {
                ...
                // execute the logic
                using SundouleiaDbContext dbContext = _dbContextFactory.CreateDbContext();
